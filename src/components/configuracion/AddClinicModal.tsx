  ...
  return (
    ...
    >
      <div
        ...
        aria-modal='true'
        aria-label={title}
        className='relative w-[min(53rem,95vw)] max-h-[90vh] overflow-hidden rounded-lg bg-white shadow-xl'
      ...
      >
        ...
        <header className='flex h-14 items-center justify-between border-b border-neutral-300 px-8'>
          ...
          <button
            ...
            onClick={onClose}
            aria-label='Cerrar'
            className='size-3.5 text-neutral-900 hover:text-neutral-600 transition-colors'
          >
            <CloseRounded />
          </button>
        </header>
        ...
        <form onSubmit={handleSubmit} className='max-h-[calc(90vh-3.5rem)] overflow-y-auto'>
          <div className='flex flex-col gap-10 px-8 py-8'>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <div className='flex flex-col gap-6'>
                ...
                <div className='flex flex-col gap-2'>
                  <p className='font-inter text-sm leading-5 text-neutral-900'>Días de apertura</p>
                ...
                <div className='flex flex-col gap-3'>
                  <p className='font-inter text-sm leading-5 text-neutral-900'>Teléfono</p>
                ...
                {/* Emails */}
                <div className='flex flex-col gap-3'>
                  <p className='font-inter text-sm leading-5 text-neutral-900'>Email</p>
            ...
            <div className='flex justify-end'>
              <button
                type='submit'
                className='flex h-10 w-[min(12.2rem,100%)] items-center justify-center rounded-full bg-brand-500 px-4 py-2 text-base leading-6 font-medium text-brand-900 transition-colors hover:bg-brand-400'
              >
                {submitLabel}
              </button>
            </div>
