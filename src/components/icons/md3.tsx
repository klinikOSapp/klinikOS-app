...
export const AttachFileRounded = createLegacyIcon('AttachFileRounded')
export const BadgeRounded = createLegacyIcon('BadgeRounded')
export const BarChartRounded = createLegacyIcon('BarChartRounded')
export const BrightnessHighRounded = createLegacyIcon('BrightnessHighRounded')
...
export const CompareRounded = createLegacyIcon('CompareRounded')
export const ContrastRounded = createLegacyIcon('ContrastRounded')
export const ContentCopyRounded = createLegacyIcon('ContentCopyRounded')
...
export const FilePresentRounded = createLegacyIcon('FilePresentRounded')
export const FilterAltRounded = createLegacyIcon('FilterAltRounded')
...
export const FullscreenRounded = createLegacyIcon('FullscreenRounded')
...
export const LocalHospitalRounded = createLegacyIcon('LocalHospitalRounded')
export const MedicalServicesRounded = createLegacyIcon('MedicalServicesRounded')
...
export const RestartAltRounded = createLegacyIcon('RestartAltRounded')
...
export const TableRowsRounded = createLegacyIcon('TableRowsRounded')
export const TimelineRounded = createLegacyIcon('TimelineRounded')
export const ViewTimelineRounded = createLegacyIcon('ViewTimelineRounded')
...
export const WarningRounded = createLegacyIcon('WarningRounded')
export const ZoomInRounded = createLegacyIcon('ZoomInRounded')
export const ZoomOutRounded = createLegacyIcon('ZoomOutRounded')
