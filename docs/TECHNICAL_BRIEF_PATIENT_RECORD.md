...
### 10.4 Pending Decisions (for the team)
...
## 11. Connections with Other System Modules
...
### 11.2 Connection Details by Module

#### 11.2.1 SCHEDULE (`/schedule`) ↔ Patient Record
...
#### 11.2.2 MANAGEMENT (`/management`) ↔ Patient Record
...
#### 11.2.3 CASH (`/cash`) ↔ Patient Record
...
#### 11.2.4 DAILY REPORT (`/daily-report`) ↔ Patient Record
...
#### 11.2.5 CONFIGURATION (`/settings`) → Patient Record
...
### 11.3 Permission Matrix by Module
...
### 11.4 Events and Notifications Between Modules
...
### 11.5 Critical Connection Queries
